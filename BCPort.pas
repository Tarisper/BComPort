...
//  ---------------------------------------------------------------------  //
//  Êîìïîíåíò äëÿ îáìåíà äàííûìè ñ âíåøíèìè óñòðîéñòâàìè ÷åðåç èíòåðôåéñ   //
//  RS-232 â àñèíõðîííîì èëè ñèíõðîííîì ðåæèìå. Ðàçðàáîòàí íà îñíîâå       //
//  áèáëèîòåêè ComPort Library îò Dejan Crnila.                            //
//            Ðàáîòàåò ñ Delphi 2..7 ïîä Windows 9X/ME/NT4/2K/XP.          //
//  ---------------------------------------------------------------------  //
//                 (c) 2005 Áðóñíèêèí È.Â.    majar@nm.ru                  //
//                                                                         //
/////////////////////////////////////////////////////////////////////////////
...
const
  ...
  CEMess: array[1..15] of ansistring =
    ('Ïîïûòêà îòêðûòü íåñóùåñòâóþùèé COM-ïîðò',
     'Ïîðò çàíÿò äðóãîé ïðîãðàììîé',
     'Îøèáêà çàïèñè â ïîðò',
     'Îøèáêà ÷òåíèÿ èç ïîðòà',
     'Íåäîïóñòèìûé ïàðàìåòð Async',
     'Îøèáêà ôóíêöèè PurgeComm',
     'Íå óäàëîñü ïîëó÷èòü ñòàòóñ àñèíõðîííîé îïåðàöèè',
     'Îøèáêà ôóíêöèè SetCommState',
     'Îøèáêà ôóíêöèè SetCommTimeouts',
     'Îøèáêà ôóíêöèè SetupComm',
     'Îøèáêà ôóíêöèè ClearCommError',
     'Îøèáêà ôóíêöèè GetCommModemStatus',
     'Îøèáêà ôóíêöèè EscapeCommFunction',
     'Íåëüçÿ ìåíÿòü ñâîéñòâî, ïîêà ïîðò îòêðûò',
     'Îøèáêà îáðàùåíèÿ ê ñèñòåìíîìó ðååñòðó');
...
const
  CBaudRate: array[TBaudRate] of Integer = (CBR_110, CBR_300, CBR_600,
    ...
    CBR_56000, CBR_57600, CBR_115200, CBR_128000, CBR_256000, CBR_460800);
var
  DCB: TDCB;
begin
